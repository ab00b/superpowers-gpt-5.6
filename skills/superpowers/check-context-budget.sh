...
require_contract "$SCRIPT_DIR/executing-plans/SKILL.md" 'Treat requirements and acceptance as authority; the plan argues how.'
require_contract "$SCRIPT_DIR/executing-plans/SKILL.md" 'small same-shape outcomes into one execution/review unit'
...
require_contract "$SCRIPT_DIR/finishing-a-development-branch/SKILL.md" 'git status --short --untracked-files=all --ignored=matching'
require_contract "$SCRIPT_DIR/finishing-a-development-branch/SKILL.md" 'no required work remaining'
require_contract "$SCRIPT_DIR/finishing-a-development-branch/SKILL.md" 'Ignore only verified regenerable artifacts'
require_contract "$SCRIPT_DIR/finishing-a-development-branch/SKILL.md" 'Never force removal without explicit destructive authorization.'
...
require_contract "$SCRIPT_DIR/test-driven-development/writing-good-tests.md" 'Every test should name a realistic production break.'
require_contract "$SCRIPT_DIR/test-driven-development/writing-good-tests.md" 'If nothing fails, the behavior is unprotected or the test is tautological.'
...
require_contract "$SCRIPT_DIR/writing-skills/SKILL.md" 'Text validators prove structure, not agent behavior.'
